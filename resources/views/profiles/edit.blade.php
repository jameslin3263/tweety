...
@section('content')
	<form method="POST" action="{{ $user->path()}}" enctype="multipart/form-data">
		...
		<div class="mb-6">
			<label class="block mb-2 uppercase font-blod text-xs text-gray-700" for="username">
				Username
			</label>
		...
		<div class="mb-6">
			<label class="block mb-2 uppercase font-blod text-xs text-gray-700" for="avatar">
				Avatar
			</label>
			<div class="flex">
				<input class="border border-gray-400 p-2 w-full"
		...
		<div class="mb-6">
			<label class="block mb-2 uppercase font-blod text-xs text-gray-700" for="password_confirmation">
